...
class Twitter() {
    ...
    val followMap = mutableMapOf<Int, MutableList<Int>>()
    ...
    fun getNewsFeed(userId: Int): List<Int> {
        ...
        followMap.getOrDefault(userId, mutableListOf<Int>()).forEach { f ->
    ...
    fun follow(followerId: Int, followeeId: Int) {
        ...
        val followees = followMap.getOrDefault(followerId, mutableListOf<Int>())
